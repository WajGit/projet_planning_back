...
class PlanningType
{
   ...
   */
  #[ORM\OneToMany(targetEntity: Group::class, mappedBy: 'planningType', cascade: ['persist'])]
  ...
  #[ORM\OneToMany(mappedBy: 'planningType', targetEntity: Rotation::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
